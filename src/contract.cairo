...
pub mod ERC6105NoIntermediaryNftTradingProtocol {
    ...
    use erc_6105_no_intermediary_nft_trading_protocol::components::erc6105::ERC6105Component;
    use erc_6105_no_intermediary_nft_trading_protocol::components::collection_offer::ERC6105CollectionOfferComponent;
    use erc_6105_no_intermediary_nft_trading_protocol::components::item_offer::ERC6105ItemOfferComponent;
